...
| ![](../../images/image-20220704191537496.png) |
| --- |
...
| ![](../../images/image-20220704192557175.png) |
| --- |
| 图 3-2 整数寄存器 |
...
| ![](../../images/image-20220704194524240.png) |
| --- |
| 图 3-3 操作数格式。**比例因子 `s` 必须是 1、2、4 或者 8**。 |

地址计算的练习

| ![](../../images/add-computation-example.jpg) |
| --- |
|  |
...
| ![](../../images/image-20220704194834339.png) |
| --- |
| 图 3-4 简单的数据传送指令 |
...
| ![](../../images/image-20220828200248791.png) |
| --- |
| 图 3-8 入栈和出栈指令 |
...
| ![](../../images/image-20220705193103548.png) |
| --- |
...
| ![](../../images/image-20220705194040325.png) |
| --- |
...
| ![](../../images/image-20220705195332940.png) |
| --- |
...
| ![](../../images/image-20220902201422665.png) |
| --- |
| 图 3-14 `SET` 指令 |
...
| ![](../../images/image-20220705195602494.png) |
| --- |
| 图 3-15 `jump` 指令 |
...
| ![](../../images/image-20220905144239732.png) |
| --- |
| 图 3-22 `switch` 语句示例以及翻译到扩展的 C 语言。 该翻译给出了跳转表 `jt` 的结构，以及如何访问它。作为对 C 语言的扩展，GCC 支持这样的表。 |
| ![](../../images/image-20220905144652985.png) |
| 上图 `switch` 语句示例的汇编代码 |
| ![](../../images/image-20220905145814013.png) |
| 在汇编代码中，跳转表用上述声明表示 |
...
| ![](../../images/image-20220706195512876.png) |
| --- |
| 图 3-25 通用的栈帧结构 |
...
| ![](../../images/image-20220706200736910.png) |
| --- |
