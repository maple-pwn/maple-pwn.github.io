...
| ![](../../images/image-20250408175916815-1744553199019-1.png) |
| ------------------------------------------------------------- |
| 图1.3 数字计算机的一般结构                                    |
...
| ![](../../images/image-20250408181638098-1744553199019-2.png) |
| ------------------------------------------------------------- |
| 图1.2 数字系统的层次结构                                      |
...
| ![](../../images/image-20250408190811729-1744553199019-3.png) |
| ------------------------------------------------------------- |
| 表1.4 与4为二进制码对应的典型格雷码                           |

_其实就是第一位不变，后面每一位和前一位取异或_
...
| ![](../../images/image-20250408201853341-1744553199020-5.png) |
| ------------------------------------------------------------- |
| 图3.5 三极管开关电路及其输出特性                              |
...
4. 平均传输延迟时间
   ...
   **tpd** : _指一个矩形波信号从与非门输入端传到与非门输出端所延迟的时间_

| ![](../../images/image-20250411224611549-1744553199020-4.png) |
| ------------------------------------------------------------- |
| 图3.14 TTL与非门的传输延迟时间                                |
...
| ![](../../images/image-20250411225406493-1744553199020-6.png) |
| ------------------------------------------------------------- |
...
| ![](../../images/image-20250411225612363-1744553199020-7.png) |
| ------------------------------------------------------------- |
| 图3.21 两个TTL与非门输出端直接并接使用的情况                  |

为了实现 **线与** 功能，设计了 **集电极开路门（OC门)** 。电路结构和逻辑符号如下：

| ![](../../images/image-20250411230035607-1744553199020-10.png) |
| -------------------------------------------------------------- |
...
| ![](../../images/image-20250411230441440-1744553199020-8.png) |
| ------------------------------------------------------------- |
...
| ![](../../images/image-20250411231041004-1744553199020-9.png) |
| ------------------------------------------------------------- |
| 表3.12 常用门电路符号及表达式                                 |
...
| ![](../../images/image-20250413215624508.png) |
| --------------------------------------------- |
| 图3.36 与非门构成的R-S触发器                  |
...
| ![](../../images/image-20250413215802584.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250413220217886.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250413220600877.png) |
| --------------------------------------------- |
...
**_也就是说：圆圈里的状态，经过标注所示的信号输入，可以变成箭头指向的状态_**
...
| ![](../../images/image-20250413221453402.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250413221633384.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250413222303966.png) |
| --------------------------------------------- |
| 图3.42 或非门构成的R-S触发器                  |

| ![](../../images/image-20250413222327091.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250413223114085.png) |
| --------------------------------------------- |
| 图3.43 钟控R-S触发器                          |
...
| ![](../../images/image-20250413223958797.png) |
| --------------------------------------------- |
| 图3.45 钟控D触发器                            |
...
| ![](../../images/image-20250413224320658.png) |
| --------------------------------------------- |
| 功能表、状态表、激励表、状态图如图            |
...
| ![](../../images/image-20250413224614571.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250413225036243.png)    |
| ------------------------------------------------ |
...
| ![](../../images/image-20250413225428236.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250413225645294.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250413231305898.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250413233146127.png) |
| --------------------------------------------- |
...
分为代数法和卡诺图法，**_代数法不好用，就是枚举，直接卡诺图_**

| ![](../../images/image-20250414181223422-1745717181159-1.png) |
| ------------------------------------------------------------- |
| 卡诺图判断险象                                                |
...
| ![](../../images/image-20250414181921798-1745717181159-2.png) |
| ------------------------------------------------------------- |
| 图4.24 卡诺图                                                 |
...
| ![](../../images/image-20250414191238993-1745717181159-6.png) |
| ------------------------------------------------------------- |
| 图5.1 时序逻辑电路的一般结构                                  |
...
| ![](../../images/image-20250414195532996-1745717181159-3.png) |
| ------------------------------------------------------------- |
| 图5.3 两种模型的输出/输入关系图                               |
...
| ![](../../images/image-20250414195657014-1745717181159-4.png) |
| ------------------------------------------------------------- |
| 图5.5 时序逻辑电路的输入信号波形                              |
...
| ![](../../images/image-20250414201937176-1745717181159-5.png) |
| ------------------------------------------------------------- |
...
| ![](../../images/image-20250427092547890.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250427093651575.png) |
| --------------------------------------------- |
| 图5.7 同步时序逻辑电路的分析过程              |
...
| ![](../../images/image-20250427101317023.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250427112601021.png) |
| --------------------------------------------- |
| 图5.25 状态化简的一般步骤                     |
...
| ![](../../images/image-20250429190831285.png) | ![](../../images/image-20250429190906387.png) |
| --------------------------------------------- | --------------------------------------------- |
| 表5.17 R-S触发器激励表                        | 表5.18 D触发器激励表                          |
| ![](../../images/image-20250429191523048.png) | ![](../../images/image-20250429191555703.png) |
...
| ![](../../images/image-20250429200909866.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250506192913868.png) |
| --------------------------------------------- |
| **图7.7 74138译码器的引脚排列图和逻辑符号**   |

该译码器真值表如表7.1

| ![](../../images/image-20250506193008076.png) |
| --------------------------------------------- |
| **表7.1 74138译码器真值表**                   |
...
| ![](../../images/image-20250506194945850.png) |
| --------------------------------------------- |
| **图7.11 7448的引脚排列图和逻辑符号**         |

| ![](../../images/image-20250506195014682.png) |
| --------------------------------------------- |
| 表7.4 7448的功能表                            |

| ![](../../images/image-20250506195114686.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250506195703886.png) |
| --------------------------------------------- |
| 图7.13 按键式8421码编码器                     |
...
| ![](../../images/image-20250506201224963.png) |
| --------------------------------------------- |
| 图7.14 74148优先编码器引脚排列和逻辑符号      |

| ![](../../images/image-20250506201300750.png) |
| --------------------------------------------- |
| 表7.6 74148真值表                             |

- 下角标的号码越大，优先级越高。

> 例如，I1、I4、I6为0，其余为1.输出按优先级较高的I6编码，也就是QcQBQA=001,_(6)10=(110)2_
>
> 当I6=1时，QcQBQA=011，_(4)10=(100)2_
>
> 若当I4也为1时，QcQBQA=110,_(1)10=(001)2_
...
| ![](../../images/image-20250506205310964.png) |
| --------------------------------------------- |
| 图7.16 74153引脚排列图和逻辑符号              |

功能表如下

| ![](../../images/image-20250506205425048.png) |
| --------------------------------------------- |
...
| ![](../../images/image-20250506210122267.png) |
| --------------------------------------------- |
| 图7.20 4路DEMUX的逻辑符号                     |
...
| ![](../../images/image-20250506210246818.png) |
| --------------------------------------------- |
| 表7.8 4路DEMUX功能表                          |

> 其实就是，A1A0对应的二进制数是几，就将D的值从第几个口输出，其它口都输出0

_DEMUX常与MUX联用，以实现多通道数据分时传送_。通常在发送端由MUX将各路数据分时送至公共传输线，接收端再由DEMUX将公共线上的数据分配到相应的输出端
...
| ![](../../images/image-20250506212240956.png) |
| --------------------------------------------- |
| 图7.23 74193的引脚排列图和逻辑符号            |

| ![](../../images/image-20250506212334498.png) |
| --------------------------------------------- |
| ![](../../images/image-20250506212342305.png) |
...
| ![](../../images/image-20250506214515054.png) |
| --------------------------------------------- |
| 图7.28 74290的引脚排列图和逻辑符号            |

| ![](../../images/image-20250506214543681.png) |
| --------------------------------------------- |
| 表7.11 74290的功能表                          |
...
3. **模10计数器** ：用74290构成模10计数器有两种方法：一是构成8421码十进制计数器；二是构成5421码十进制计数器。两种方式的连接图如下图
   ...
   | ![](../../images/image-20250506222209216.png) |
   | --------------------------------------------- |
...
| ![](../../images/image-20250506224151837.png) |
| --------------------------------------------- |
| 图7.32 74194的管教排列图和逻辑符号            |

| ![](../../images/image-20250506224231519.png) |
| --------------------------------------------- |
| 74194引线说明、控制端功能、功能表             |
...
| ![](../../images/image-20250506225235549.png) |
| --------------------------------------------- |
...
_为了防止干扰，CO端一般通过一个小电容(0.01μF)接地，以防旁路高频干扰_
...
| ![](../../images/image-20250507222056867.png) |
| --------------------------------------------- |
| 表7.20 5G555功能表                            |

当CO不外接控制电压时，功能表如下(其实差不多的，可以理解为基准电压变成了一个已知值)

| ![](../../images/image-20250507222344321.png) |
| --------------------------------------------- |
